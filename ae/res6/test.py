...
def change_config_prefill_test(hardware_config, b, l):
    ...
    print (f"Config: {hardware_config['config']}, latency:{latency} pass")
    return latency
...
if __name__ == "__main__":
    ...
    change_config_decode_test(hardware_config, batch_size, 128)
    change_config_decode_test(hardware_config, batch_size, 127)